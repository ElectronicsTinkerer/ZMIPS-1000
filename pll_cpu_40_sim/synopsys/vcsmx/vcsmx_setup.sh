...
TOP_LEVEL_NAME="pll_cpu_40"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="D:/software/intelfpga_lite/21.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_cpu_40.vo"
fi
