...
=SPRITE_PLAYER_THRUST_DATA      GAME_DATA_BASE + (2 * SCREEN_WORDS) + (28 * SPRITE_MASK_OFFSET)
=SPRITE_PLAYER_THRUST_MASK      GAME_DATA_BASE + (2 * SCREEN_WORDS) + (29 * SPRITE_MASK_OFFSET)
;SPRITE_PLAYER_THRUST2_DATA     GAME_DATA_BASE + (2 * SCREEN_WORDS) + (30 * SPRITE_MASK_OFFSET)
;SPRITE_PLAYER_THRUST2_MASK     GAME_DATA_BASE + (2 * SCREEN_WORDS) + (31 * SPRITE_MASK_OFFSET)
;SPRITE_PLAYER_THRUST3_DATA     GAME_DATA_BASE + (2 * SCREEN_WORDS) + (32 * SPRITE_MASK_OFFSET)
;SPRITE_PLAYER_THRUST3_MASK     GAME_DATA_BASE + (2 * SCREEN_WORDS) + (33 * SPRITE_MASK_OFFSET)
;SPRITE_PLAYER_THRUST4_DATA     GAME_DATA_BASE + (2 * SCREEN_WORDS) + (34 * SPRITE_MASK_OFFSET)
;SPRITE_PLAYER_THRUST4_MASK     GAME_DATA_BASE + (2 * SCREEN_WORDS) + (35 * SPRITE_MASK_OFFSET)

=SPRITE_DEAD0_DATA              GAME_DATA_BASE + (2 * SCREEN_WORDS) + (36 * SPRITE_MASK_OFFSET)
=SPRITE_DEAD0_MASK              GAME_DATA_BASE + (2 * SCREEN_WORDS) + (37 * SPRITE_MASK_OFFSET)
=SPRITE_DEAD1_DATA              GAME_DATA_BASE + (2 * SCREEN_WORDS) + (38 * SPRITE_MASK_OFFSET)
=SPRITE_DEAD1_MASK              GAME_DATA_BASE + (2 * SCREEN_WORDS) + (39 * SPRITE_MASK_OFFSET)
=SPRITE_DEAD2_DATA              GAME_DATA_BASE + (2 * SCREEN_WORDS) + (40 * SPRITE_MASK_OFFSET)
=SPRITE_DEAD2_MASK              GAME_DATA_BASE + (2 * SCREEN_WORDS) + (41 * SPRITE_MASK_OFFSET)
=SPRITE_DEAD3_DATA              GAME_DATA_BASE + (2 * SCREEN_WORDS) + (42 * SPRITE_MASK_OFFSET)
=SPRITE_DEAD3_MASK              GAME_DATA_BASE + (2 * SCREEN_WORDS) + (43 * SPRITE_MASK_OFFSET)
=SPRITE_DEAD4_DATA              GAME_DATA_BASE + (2 * SCREEN_WORDS) + (44 * SPRITE_MASK_OFFSET)
=SPRITE_DEAD4_MASK              GAME_DATA_BASE + (2 * SCREEN_WORDS) + (45 * SPRITE_MASK_OFFSET)
